export const lessonMedia = {
  "1-1": {
    ...
    summary: `
      ...
      <h4>Introduction to Artificial Intelligence and Its Impact</h4>
      <h4>Video Overview</h4>
      <p>Shawaiz introduces artificial intelligence (AI), explaining its definition, capabilities, and how it differs from human intelligence and historical technologies. The lesson sets the foundation for understanding AI's broad effects.</p>
      <h4>Key Insights</h4>
      <ul>
  ...
  "1-2": {
    ...
    summary: `
      <h4>The Evolution of Artificial Intelligence Explained</h4>
      <h4>Overview of AI Development</h4>
      <ul>
      ...
      <h4>Key Advances and Core Concepts</h4>
      <ul>
      ...
      <h4>Takeaways and Recommendations</h4>
      <ul>
  ...
  "1-3": {
    ...
    summary: `
      <h4>The Evolution of AI: From Deep Learning to Transformers</h4>
      <h4>Overview of AI Progression</h4>
      <ul>
      ...
      <h4>Breakthroughs in Deep Learning and Transformers</h4>
      <ul>
      ...
      <h4>Recommendations and Takeaways</h4>
      <ul>
  ...
  "1-4": {
    ...
    summary: `
      <h4>Understanding Generative AI: How Content Is Created</h4>
      <h4>Overview of AI Progression</h4>
      <ul>
  ...
  "2-1": {
    ...
    summary: `
      <h4>How ChatGPT Processes Language and Responds</h4>
      <h4>Overview of AI Advancement</h4>
      <ul>
      ...
      <h4>How ChatGPT Understands and Replies</h4>
      <ul>
  ...
  "2-2": {
    ...
    summary: `
      <h4>Understanding AI Training vs. Usage</h4>
      <h4>Overview</h4>
      <ul>
  ...
  "2-3": {
    ...
    summary: `
      <h4>Understanding Base and Fine-Tuned AI Models</h4>
      ...
      <h4>Main Insights from Shawaiz</h4>
      <ul>
      ...
      <p>This video explains the difference between base AI models and fine-tuned models, using the analogy of baking a cake. It describes how base models are like having all the raw ingredients and knowledge but not being job-ready, while fine-tuned models are like a finished cake, trained to be helpful and practical through reinforcement learning from human feedback. The video also clarifies that ChatGPT is a fine-tuned assistant model built on top of the base GPT model, designed to provide useful and safe responses.</p>
      <h4>Action items</h4>
      <ul>
  ...
  "2-4": {
    ...
    summary: `
      <h4>Understanding AI’s Three Autonomy Levels</h4>
      <h4>Overview of AI Development</h4>
      <ul>
      ...
      <h4>The Three Levels of AI Autonomy</h4>
      <ul>
      ...
      <h4>Key Recommendations and Tips</h4>
      <ul>
  ...
  "2-5": {
    ...
    summary: `
      <h4>Understanding AI Agent Autonomy and Architecture</h4>
      <h4>Overview</h4>
      <p>Shawaiz explains the five core components required for AI agents to function: brain, memory, tools, prompt, and knowledge. He highlights how these distinguish agents from standard AI models.</p>
      <h4>Key Insights</h4>
      <ul>
  ...
  "2-6": {
    ...
    summary: `
      ...
      <h4>The Five Evaluation Questions</h4>
      <ul>
  ...
  "3-1": {
    ...
    summary: `
      <h4>From AI Theory to Everyday Products</h4>
      <h4>Shawaiz Explains the AI to Product Pipeline</h4>
      <ul>
      <li>Shawaiz outlines how AI theory becomes practical tools via a clear, four-step process.</li>
      <li>The process uses a restaurant analogy: models are the kitchen, APIs are waiters, and end-users are customers.</li>
      </ul>
      <h4>The AI Pyramid Structure</h4>
      <ul>
      <li>Few companies develop core AI models (the "chefs") like OpenAI, Google, Meta.</li>
      <li>Hundreds of companies use these models (via APIs) to build diverse products (ChatGPT, Grammarly, Notion).</li>
      <li>Millions of users ultimately interact with these finished products, not the underlying models.</li>
      </ul>
      <h4>Key Takeaways and Actions</h4>
      <ul>
  ...
  "3-2": {
    ...
    summary: `
      <h4>AI Product Framework Explained: Four Key Types</h4>
      <h4>Overview: Understanding AI Tools</h4>
      <ul>
  ...
  "3-3": {
    ...
    summary: `
      <h4>Understanding Control Levels in AI Tools</h4>
      <h4>Overview of the Control Spectrum</h4>
      <ul>
      ...
      <h4>Breakdown of the Four Levels</h4>
      <ul>
  ...
  "3-4": {
    ...
    summary: `
      <h4>Understanding Market Dynamics of AI Products</h4>
      <h4>Overview</h4>
      <ul>
      ...
      <li>Be aware of cost, competition, and access inequalities when choosing AI solutions to maintain advantage</li>
      </ul>
    `,
  ...
  "3-5": {
    ...
    summary: `
      <h4>Adapting Skills for the Age of AI</h4>
      <h4>Context and Key Questions</h4>
      <ul>
      ...
      <h4>Core Insights on Jobs and AI</h4>
      <ul>
      ...
      <p>This video discusses the impact of AI on jobs and the importance of adapting skills in the face of technological change. It highlights the difference between government and company roles in AI development, the historical lessons from technological shifts like the advent of cars, and emphasizes the necessity of understanding and using AI effectively to stay competitive. The video also outlines the course modules that bridge AI theory to practical application and prepares viewers for responsible AI usage</p>
      <h4>Action items</h4>
      <ul>
  ...
  "4-1": {
    ...
    summary: `
      <h4>Understanding AI's Double-Edged Sword</h4>
      <h4>Shawaiz explains responsible AI usage</h4>
      <ul>
      <li>AI is powerful but must be used correctly, similar to tools like calculators or healthy foods.</li>
      <li>Misusing AI for every task can weaken your critical thinking, just like eating only one type of food harms your health.</li>
      </ul>
      <h4>Key points on AI’s strengths and limits</h4>
      <ul>
      ...
      <h4>Recommendations from Shawaiz</h4>
      <ul>
      ...
      <p>This video explains the dual nature of AI, emphasizing that while AI is a powerful pattern recognition tool useful for tasks with clear patterns, it should be used responsibly and not relied upon for tasks requiring original thinking or judgment. The speaker uses analogies like calculators and bananas to illustrate the importance of using AI correctly and not overusing it, as overdependence can lead to a decline in mental capabilities.</p>
      <h4>Action items</h4>
      <ul>
  ...
  "4-2": {
    ...
    summary: `
      <h4>When to Use AI: Head vs Heart Work</h4>
  ...
  "4-3": {
    ...
    summary: `
      <h4>Identifying Real Goals in the AI Era</h4>
      <h4>Overview</h4>
      <ul>
  ...
  "4-4": {
    ...
    summary: `
      <h4>Strategic AI Use for Smarter Task Management</h4>
      <h4>Overview</h4>
      <p>Shawaiz explains how breaking tasks into components enables efficient collaboration between personal effort and AI, using essay writing as a practical example.</p>
      <h4>Main Insights</h4>
      <ul>
  ...
  "4-5": {
    ...
    summary: `
      <h4>Five Common AI Traps and Success Strategies</h4>
      <h4>Overview</h4>
      <ul>
  ...
  "4-6": {
    ...
    summary: `
      <h4>Mastering AI: Tactics for Mindful Use</h4>
      <h4>Overview</h4>
      <p>Shawaiz explains that while AI can be a powerful tool, mindful and intentional use is essential to maintaining human value and skills in a rapidly evolving landscape.</p>
      <h4>Core Strategies and Insights</h4>
      <ul>
  ...
  "5-1": {
    ...
    summary: `
      <h4>Mastering AI: How Prompt Quality Drives Results</h4>
      <h4>Why Most People Get Different AI Results</h4>
      <ul>
      ...
      <h4>How to Get Better Results from AI</h4>
      <ul>
      ...
      <h4>Key Recommendations for Effective AI Communication</h4>
      <ul>
      ...
      <p>This video explains the importance of effective communication with AI to achieve better results. It emphasizes that everyone has access to the same AI tools, but the quality of the output depends on the quality of the input prompts. Good prompts are specific, detailed, and context-aware, which leads to more productive and efficient AI interactions.</p>
      <h4>Action items</h4>
      <ul>
  ...
  "5-2": {
    ...
    summary: `
      <h4>Mastering AI Prompts with the COLD STAR Framework</h4>
      <h4>Overview</h4>
      <p>Shawaiz introduces the COLD STAR framework to help users structure AI prompts for superior results, emphasizing that clarity and specificity drive quality AI outputs.</p>
      <h4>Key Framework Insights</h4>
      <ul>
  ...
  "5-3": {
    ...
    summary: `
      <h4>Mastering Effective AI Prompting Techniques</h4>
      <h4>Overview of Iterative Prompting</h4>
      <ul>
      ...
      <h4>Key Strategies and Examples</h4>
      <ul>
  ...
  "5-4": {
    ...
    guide: '<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/zrYcpz0yf5r562MdRGb8?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>',
    summary: `
      <h4>Mastering Meta Prompting for AI Efficiency</h4>
      <h4>Overview</h4>
      <ul>
      ...
      <h4>How Meta Prompting Works</h4>
      <ul>
  ...
  "5-6": {
    ...
    summary: `
      <h4>Mastering Effective AI Communication and Prompting</h4>
      <h4>Core Context</h4>
      <ul>
      ...
      <h4>Main Insights on Prompting</h4>
      <ul>
  ...
  "6-1": {
    ...
    summary: `
      <h4>How to Become a Resilient AI User</h4>
      <h4>Overview: Shawaiz’s Core Message</h4>
      <ul>
      ...
      <h4>The Three Levels of AI Users</h4>
      <ul>
  ...
  "6-2": {
    ...
    summary: `
      <h4>Strategic Filtering for Outcome-Focused AI</h4>
      <h4>Overview</h4>
      <ul>
  ...
  "6-3": {
    ...
    summary: `
      <h4>Staying Informed on AI Without Overwhelm</h4>
      <h4>Context: Why Limit AI News?</h4>
      <ul>
      <li>Shawaiz explains that constant updates in AI—new tools, features, and industry drama—can consume hours daily and lead to information overload.</li>
      <li>Most people either spend too much time on news or risk falling behind altogether.</li>
      </ul>
      <h4>The News Budget Strategy</h4>
      <ul>
  ...
  "6-4": {
    ...
    summary: `
      <h4>How to Effectively Test New Tools</h4>
      <h4>Overview</h4>
      <ul>
  ...
  "6-5": {
    ...
    summary: `
      <h4>Building Flowing Systems with Integrated AI</h4>
      <h4>Overview</h4>
      <ul>
  ...
  "6-6": {
    ...
    summary: `
      <h4>How to Evaluate AI Outputs Based on Task Importance</h4>
      <h4>Context and Approach</h4>
      <ul>
      ...
      <h4>Main Evaluation Criteria</h4>
      <ul>
  ...
  "7-1": {
    ...
    summary: `
      <h4>Adapting for the AI-Driven Future</h4>
      <h4>Overview</h4>
      <ul>
  ...
  "7-2": {
    ...
    summary: `
      ...
      <h4>Key Topics</h4>
      <ul>
      <li>Identifying uniquely human skills that AI cannot replicate</li>
      <li>Developing emotional intelligence and creative problem-solving</li>
  ...
  "7-3": {
    ...
    summary: `
      ...
      <h4>Key Topics</h4>
      <ul>
      <li>Assessing your current skills and identifying growth areas</li>
      <li>Creating a learning roadmap aligned with your goals</li>
  ...
  "7-4": {
    ...
    summary: `
      ...
      <h4>Key Topics</h4>
      <ul>
      <li>Developing a continuous learning mindset</li>
      <li>Staying informed about AI developments without information overload</li>
  ...
  "7-5": {
    ...
    summary: `
      ...
      <h4>Key Topics</h4>
      <ul>
      <li>Reviewing key insights from the entire course</li>
      <li>Creating your 30-60-90 day action plan</li>
  ...
  "8-1": {
    ...
    summary: `
      ...
      <h4>Key Topics</h4>
      <ul>
      <li>Evaluating AI tools based on your specific needs</li>
      <li>Starting with low-risk applications to build confidence</li>
  ...
  "8-2": {
    ...
    summary: `
      ...
      <h4>Key Topics</h4>
      <ul>
      <li>Mapping out processes and identifying AI opportunities</li>
      <li>Designing checkpoints and quality controls</li>
  ...
  "8-3": {
    ...
    summary: `
      ...
      <h4>Key Topics</h4>
      <ul>
      <li>Establishing team guidelines for AI usage</li>
      <li>Creating shared playbooks and best practices</li>
  ...
  "8-4": {
    ...
    summary: `
      ...
      <h4>Key Topics</h4>
      <ul>
      <li>Defining success metrics before implementation</li>
      <li>Tracking time savings, quality improvements, and cost reduction</li>
  ...
  "8-5": {
    ...
    summary: `
      ...
      <h4>Key Topics</h4>
      <ul>
      <li>Establishing feedback loops for continuous learning</li>
      <li>Staying current with new AI capabilities and tools</li>
