export const lessonMedia = {
  "1-1": {
    ...
    summary: `<p>This video lesson provides an introduction to artificial intelligence (AI), explaining what AI is, its capabilities compared to humans, and the historical pattern of technology replacing old methods. It highlights AI's strengths in pattern recognition, memory, calculations, and language processing, while noting human superiority in understanding context, emotions, and moral judgments. The lesson emphasizes the importance of adapting to AI as a transformative technology that affects everyone and encourages learners to engage with the course to stay relevant.</p>`,
    activity: `<ol>\n<li>Pick one task you need to do today</li>\n<li>Paste it into ChatGPT or Claude</li>\n<li>Use the output for your work</li>\n</ol>`
  },

  "1-2": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/GJhn0kf4nXwLwwbUEW1a?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/jBIIrLjgijfZ161XGTjM?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>The Evolution of Artificial Intelligence Explained
Overview of AI Development
Shawaiz introduces the lesson by framing AI as a technology developed to replicate human intelligence.
The historical journey starts from the fundamental question, "Can machines think?" posed by Alan Turing in 1950.
Key Advances and Core Concepts
Rule-based AI was the first approach, eventually coined "artificial intelligence" by John McCarthy in 1956.
The perceptron—a model of an artificial neuron—was invented in 1957, followed by early chatbots like Eliza (1966), which exposed the limits of rule-based systems.
Machine learning emerged to enable AI to learn from data, with supervised, unsupervised, and reinforcement learning paradigms.
The 1986 breakthrough of the backpropagation algorithm allowed neural networks to learn from mistakes, moving AI beyond explicit programming.
Takeaways and Recommendations
View AI as a tangible technology to better grasp its potential.
Remember that initial rule-based approaches failed due to complexity and lack of adaptability.
Embrace machine learning and neural networks for ongoing progress in artificial intelligence.

This lesson provides an overview of the development of artificial intelligence (AI) from its inception. It covers key milestones including the Turing Test, rule-based AI, the invention of the perceptron, early chatbots like Eliza, the limitations of rule-based systems leading to the AI winter, and the emergence of machine learning with supervised, unsupervised, and reinforcement learning. The breakthrough of the backpropagation algorithm in 1986, which enabled neural networks to learn from mistakes, is highlighted as a pivotal advancement in AI technology.</p>`,
  ...
  "1-3": {
    ...
    summary: `<p>The Evolution of AI: From Deep Learning to Transformers
Overview of AI Progression
Shawaiz traces AI history from the Turing Test and rule-based systems to modern breakthroughs.
Early limits: Rule-based AI was too rigid; basic machine learning had modest pattern recognition but hit a ceiling.
Breakthroughs in Deep Learning and Transformers
Deep learning gave AI ‘bigger brains’ using stacked neural networks for complex pattern recognition (e.g., face and voice recognition, translation).
The 2017 Transformer model let AI remember context like a human, enabling systems like ChatGPT to learn and understand language at scale.
Recommendations and Takeaways
Focus on patterns: AI learns from clear patterns; more data and depth improves results.
Transformers solved AI’s ‘memory problem,’ revolutionizing understanding and conversation capacity.
Practice and apply: Continue with assigned tasks to reinforce understanding.

This video explains the evolution of AI technology, focusing on deep learning and the breakthrough of Transformers in 2017. It describes how deep learning uses multiple neural network layers to recognize complex patterns, and how Transformers solved the AI memory problem, enabling AI to understand context and language more effectively, as seen in models like ChatGPT.
Edit</p>`,
  ...
  "1-4": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/jDyUnrTKVe9bZtenrvWT?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/j8k1YlqqouTJqVP0z2U6?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Understanding Generative AI: How Content Is Created
Overview of AI Progression
Shawaiz explains how AI has evolved from rule-based approaches to generative models capable of creating human-like text, images, videos, and code.
Different AI models are trained for specialized tasks, similar to teaching children various skills.
How Generative AI Works
Generative AI relies on compression and generalization to create new content; it predicts and generates patterns, not limited to mimicking but also producing original combinations.
Advances in datification, computational power, research investment, and breakthroughs like deep learning have fueled recent rapid growth in AI capabilities.
Key Takeaways
AI operates through pattern prediction, not emotion or true understanding.
Recent AI progress is due to abundant data, efficient computation, increased funding, and key tech breakthroughs.
Main goal: Build intelligent machines to act human-like, regardless of the specific AI branch.

This video lesson explains how AI generates new content through pattern recognition and prediction, focusing on the evolution from rule-based AI to generative AI. It uses the metaphor of teaching babies different skills to illustrate how AI models are trained for specialized tasks and discusses the recent explosion of AI due to data availability, computational power, funding, and technological breakthroughs. The video also covers the concepts of compression, generalization, and generation in AI content creation, and highlights the distinction between AI's pattern prediction and human understanding or emotions.</p>`,
  ...
  "2-1": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/KbIKpTs5iKutZja0V8CY?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/6GkqwFp3EqN5358qMWJ7?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>How ChatGPT Processes Language and Responds
Overview of AI Advancement
Shawaiz describes AI’s rapid progress from voice command tools to generative models that create original content and now act as personal assistants.
By 2023, AI shifted from simple predictions to helping users accomplish full tasks, resembling a highly capable assistant.
How ChatGPT Understands and Replies
When users type messages, ChatGPT breaks input into “tokens” (parts of words), converting these into numbers it can process—AI never understands language directly.
ChatGPT uses a “context window” (short-term memory) to include recent conversation history, like a human recalling previous remarks.
It predicts responses token by token, choosing the most probable next part, and learns when to stop based on training data.
Essential Takeaways
AI processes words as tokens and numbers, finding patterns—there is no real understanding or emotion.
ChatGPT keeps context short-term; longer chats may cause earlier details to be lost.
The system operates by predicting, not truly comprehending, making responses mathematical rather than thoughtful.
This video explains the evolution of AI from simple analysis and categorization to advanced generative AI capable of creating content and acting as a personal assistant. It details how AI like ChatGPT processes language by converting words into tokens, using a context window as short-term memory, and predicting the next token to generate coherent responses. The video emphasizes that AI operates purely on pattern recognition and probability without true understanding or feelings.</p>`,
  ...
  "2-2": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/cnSJUrJIAv3PjkTqUuej?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/WsWQyzCKSw08aNCrOT8d?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Understanding AI Training vs. Usage
Overview
Shawaiz clarifies one of the most misunderstood concepts about AI: the difference between training and using AI models.
Explains that training is a one-time, resource-intensive process, while usage is quick and ongoing.
Main Concepts
Training AI is like learning to ride a bike: difficult, slow, costly, and happens only once.
Using AI is like riding a bike after learning: easy, automatic, utilizing what has been trained.
ChatGPT does not learn from your conversations; it uses short-term memory for a session but forgets after each chat.
Key Takeaways
AI learns during initial training, not while chatting with users.
Conversations are temporary and do not update the AI’s core knowledge.
Misconception: AI remembers everything you say—Shawaiz explains this is false.
The video explains the distinction between AI training and AI usage. Training is a costly, time-consuming process where the AI learns from vast amounts of data, while usage refers to interacting with the AI, which does not learn or update its knowledge during conversations. The video uses analogies like learning to ride a bike or drive a car to clarify that AI does not learn from individual chats but operates based on its pre-trained knowledge.</p>`,
  ...
  "2-3": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/72Dvpp8Ri58d4HabtatD?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/oArCup55uTp4xQMreqQ8?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Understanding Base and Fine-Tuned AI Models
Key Concepts Explained
Shawaiz explains the distinction between base models (like GPT) and fine-tuned assistant models (like ChatGPT), using practical analogies in cooking and jobs.
The base model learns language patterns during large-scale pre-training but lacks context for helpfulness; fine-tuning turns it into a practical assistant.
Main Insights from Shawaiz
Fine-tuned models, such as ChatGPT, are akin to a finished cake—created by adjusting the base model through human feedback until responses are helpful.
Reinforcement learning from human feedback is the central process for fine-tuning, with humans ranking answers and guiding improvement.
Only researchers need the base model (the "ingredients"); users want the helpful assistant (the "cake").
Practical Takeaways
Remember: GPT = base model; ChatGPT = fine-tuned assistant.
Fine-tuning is what enables AI to provide safe and useful answers.
Reinforcement learning and feedback are critical steps for creating effective assistants.
As of 2023, models like ChatGPT are typical assistants, but future lessons will cover upcoming capabilities.
This video explains the difference between base AI models and fine-tuned models, using the analogy of baking a cake. It describes how base models are like having all the raw ingredients and knowledge but not being job-ready, while fine-tuned models are like a finished cake, trained to be helpful and practical through reinforcement learning from human feedback. The video also clarifies that ChatGPT is a fine-tuned assistant model built on top of the base GPT model, designed to provide useful and safe responses.</p>`,
  ...
  "2-4": {
    ...
    summary: `<p>Understanding AI’s Three Autonomy Levels
Overview of AI Development
Shawaiz traces AI's evolution from the Turing test to modern assistant and agent models.
Compares AI's growth to human development, describing increasing responsibility and independence.
The Three Levels of AI Autonomy
Level 1: LLMs (e.g. ChatGPT) – Like a child; learns patterns and responds but needs instruction for all tasks, with no memory between uses.
Level 2: Workflows – Like a teenager; can take sequential actions when set up, follows explicit instructions, has limited decision-making.
Level 3: Agents – Like an adult; recognizes patterns, decides and acts to complete complex tasks, needs less guidance but supervision is still important.
Key Recommendations and Tips
Evaluate AI by: What patterns did it learn? Can it take action? What does it remember, and for how long?
Use the autonomy ladder to assess current AI capability.
Recognize that Level 3 agents can act but require oversight.
Continue using simpler tools when appropriate.
Next, explore how agents work in detail.

This video explains the three levels of AI autonomy, comparing AI development to human growth from a child to an adult. It describes level one as language models like ChatGPT that generate responses but require human action, level two as workflows that can perform multiple steps but need human setup, and level three as agents that can independently make decisions and take actions. The video also introduces three evaluation questions to assess AI's capabilities: the patterns it learned from, whether it can take action, and its memory duration.</p>`,
  ...
  "2-5": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/bdifkbnMC4h3WEKEF9qq?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/Z1vKIqB2mUGibJ6mjoJX?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Understanding AI Agent Autonomy and Architecture
Overview
Shawaiz explains the five core components required for AI agents to function: brain, memory, tools, prompt, and knowledge. He highlights how these distinguish agents from standard AI models.
Key Insights
The "brain" enables pattern recognition and decision-making; memory stores information long-term and across tasks.
Tools let agents interact with systems (e.g., email, calendars), while prompts define their roles and knowledge provides essential context or data.
A practical example shows how an agent adapts plans and updates tasks, showcasing true autonomy compared to LLMs and workflows.
Actionable Takeaways
Ensure AI agents are provided with all five components for independent operation.
Always supervise agents due to privacy and security concerns.
Use the five evaluation questions to assess any AI system’s autonomy.
This video explains the architecture of AI agents, detailing the five essential components they need to function: a brain (pattern recognition and AI core), memory (short-term and long-term), tools (capabilities to perform tasks), a prompt (job description), and knowledge (specific information beyond training data). It illustrates how agents operate through a homework management example, emphasizing their ability to adapt to changes and the importance of privacy and supervision. The video also discusses the autonomy levels of AI systems, distinguishing between LLMs, workflows, and agents based on decision-making capabilities.</p>`,
  ...
  "2-6": {
    ...
    summary: `<p>5 Key Questions to Evaluate Any AI Tool
Overview of the Framework
Shawaiz shares five essential questions to assess any AI system’s capabilities, use cases, and trustworthiness.
Understanding these questions provides clarity on strengths, weaknesses, and best usage practices.
The Five Evaluation Questions
What patterns did the AI learn from?
Is it generating content or taking actions?
What does it remember, and for how long?
What tools does it have access to?
Who makes the decisions—you or the AI?
Actionable Takeaways
Check an AI’s learning sources and memory to gauge strength and limitations.
Match supervision to the AI’s autonomy—higher autonomy needs more oversight.
Review tool access and always verify outputs before acting on important decisions.

This video presents a framework of five essential questions to evaluate any AI tool, covering its learning patterns, action capabilities, memory, tool access, and decision-making authority. Understanding these questions helps users grasp AI strengths, limitations, interaction methods, and trust levels. The video also reviews foundational AI concepts such as tokens, training, fine-tuning, and levels of AI autonomy, preparing viewers to effectively assess and utilize AI systems.</p>`,
  ...
  "3-1": {
    ...
    summary: `<p>From AI Theory to Everyday Products
Shawaiz Explains the AI to Product Pipeline
Shawaiz outlines how AI theory becomes practical tools via a clear, four-step process.
The process uses a restaurant analogy: models are the kitchen, APIs are waiters, and end-users are customers.
The AI Pyramid Structure
Few companies develop core AI models (the "chefs") like OpenAI, Google, Meta.
Hundreds of companies use these models (via APIs) to build diverse products (ChatGPT, Grammarly, Notion).
Millions of users ultimately interact with these finished products, not the underlying models.
Key Takeaways and Actions
Remember the pyramid: a small number of model makers, many product builders, millions of users.
APIs make powerful AI accessible and user-friendly for non-technical people.
The wide range of AI products results from many builders adapting a few core models to different needs.
This video explains the journey of AI from theoretical models to practical products accessible to users. It describes the process of building AI models by companies, making them accessible through APIs, and how various products use these APIs to create diverse AI applications. The video uses a restaurant analogy to illustrate the AI pyramid, where a few model makers power many product builders, who in turn serve millions of users.</p>`,
  ...
  "3-2": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/mA55FXqIiAbBErJ2uq1B?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/QOLcno6dh3wBeFrgZkSa?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>AI Product Framework Explained: Four Key Types
Overview: Understanding AI Tools
Shawaiz introduces a simple framework to classify AI products by two questions: What can it do (generalist vs. specialist)? Where does it live (stand-alone vs. integrated)?
Main Product Categories
Generalist stand-alone: Versatile tools (e.g., ChatGPT) for varied needs.
Specialist stand-alone: Focused tools excelling at one task (e.g., Midjourney for images).
Generalist integrated: Broad AI built into existing apps (e.g., Microsoft Co-Pilot).
Specialist integrated: Specific AI features within tools (e.g., Grammarly in writing platforms).
Actionable Takeaways
When evaluating an AI tool, ask: Is it generalist or specialist? Is it stand-alone or integrated?
Use this framework to quickly understand any AI product's purpose.
Categorize tools to choose the right AI for your specific needs.


This video explains a product framework for understanding AI tools and products by categorizing them based on two key questions: how broad their capabilities are (generalist vs specialist) and where they live (stand-alone vs integrated). It introduces four categories of AI products with car analogies to illustrate their use cases and effectiveness. The video concludes by mentioning an upcoming lesson on the level of control users have over AI tools.</p>`,
  ...
  "3-3": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/aUirEIIY1IV60OAAf4j7?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/WWQIw7ziSFrVsvqwUhz9?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Understanding Control Levels in AI Tools
Overview of the Control Spectrum
Shawaiz introduces four levels of user control in AI tools, from full provider control to full user control.
Each level is illustrated with a car analogy for clarity.
Breakdown of the Four Levels
Level 1: Provider controls everything (like taking a taxi); easiest to use, minimal customization.
Level 2: User can adjust settings (like renting a car); some personalization, but main controls stay with the provider.
Level 3: User builds on provider's platform (like assembling a car kit); high customization, requires technical skill.
Level 4: User controls everything (like owning a car); full privacy and customization, but demands advanced knowledge and maintenance.
Key Takeaways & Recommendations
Start with simple AI products, then increase control as your needs and skills grow.
Assess your technical abilities before advancing to higher control levels.
Choose the control level that best fits your privacy needs, skills, and goals.

The video explains the different levels of control users have over AI tools and products, ranging from the AI controlling everything to the user having full control. It uses car analogies to illustrate each level, highlighting the advantages and disadvantages of each control level. The video also discusses the progression users can make from simple AI tools to fully customized AI solutions, emphasizing the balance between ease of use and technical knowledge required.</p>`,
  ...
  "3-4": {
    ...
    summary: `<p>Understanding Market Dynamics of AI Products
Overview
Shawaiz explains the key market forces shaping the development and adoption of AI products.
The lesson is designed to help viewers understand industry trends using practical frameworks.
Main Insights
Five market forces: competition, cost, business models, access/inequality, and the pace of innovation.
Intense competition drives rapid product releases, similar to battles between major tech brands.
High development costs, free vs. paid tool strategies, and access inequalities affect adoption; frameworks help make sense of fast changes.
Actionable Takeaways
Focus on your needs and select tools that best match them.
Stay flexible and avoid getting attached to specific products.
Invest in understanding frameworks—not just individual tools—to keep pace with industry shifts.
Be aware of access gaps; spending on the right tools can create advantages.
Expect constant change and evaluate new offerings carefully.

This video explains the market dynamics shaping AI products, focusing on five key forces: competition, cost, business models, access and inequality, and the pace of innovation. It emphasizes the importance of staying flexible with AI tools, understanding frameworks over specific products, and recognizing the economic and competitive factors influencing AI development and accessibility</p>`,
  ...
  "3-5": {
    ...
    summary: `<p>Adapting Skills for the Age of AI
Context and Key Questions
Shawaiz explains that predicting the future of AI is uncertain; principles and lessons from history matter most.
AI is mainly developed by companies, not governments, influencing its rollout and priorities.
Core Insights on Jobs and AI
Past technological shifts (cars replacing horses) eliminated some jobs but created others; adaptability was key.
The most important skill for today is adapting existing expertise to new contexts, especially as AI takes on more mental work.
Those who use AI tools efficiently will outcompete others; using AI is more valuable than resisting it.
Actionable Takeaways
Focus on adapting your skills to remain relevant.
Actively learn how AI works and can be applied to your field.
Use AI as a tool to enhance productivity, not as a threat.
Approach AI with an open mind—neither too fearful nor overly optimistic.
Prepare for ongoing changes and keep updating your knowledge.

This video discusses the impact of AI on jobs and the importance of adapting skills in the face of technological change. It highlights the difference between government and company roles in AI development, the historical lessons from technological shifts like the advent of cars, and emphasizes the necessity of understanding and using AI effectively to stay competitive. The video also outlines the course modules that bridge AI theory to practical application and prepares viewers for responsible AI usage</p>`,
    activity: `<p>Replace with actual activity content</p>`
  },

  "4-1": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/K9nwLMTHenPIvUs43kLR?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/Zc30xpWEEI4V9ztEkceF?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Understanding AI's Double-Edged Sword
Shawaiz explains responsible AI usage
AI is powerful but must be used correctly, similar to tools like calculators or healthy foods.
Misusing AI for every task can weaken your critical thinking, just like eating only one type of food harms your health.
Key points on AI’s strengths and limits
AI excels at tasks with clear, repeatable patterns (e.g., data analysis, basic computations).
It struggles with original thinking, emotional intelligence, and judgment, which have no clear patterns.
Knowing the boundaries helps avoid over-reliance and poor learning habits.
Recommendations from Shawaiz
Use AI for pattern-based, structured tasks.
Avoid using AI for decisions requiring creativity or personal judgment.
Balance AI usage with self-learning and problem-solving.
Recognize the temptation to overuse AI, and practice mindful application.
Remember: AI is a tool, not a replacement for human growth.

This video explains the dual nature of AI, emphasizing that while AI is a powerful pattern recognition tool useful for tasks with clear patterns, it should be used responsibly and not relied upon for tasks requiring original thinking or judgment. The speaker uses analogies like calculators and bananas to illustrate the importance of using AI correctly and not overusing it, as overdependence can lead to a decline in mental capabilities.</p>`,
  ...
  "4-2": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/ynk6S3RFVy9QPiZmSyfD?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/T1UJMPCEo3DALYFHyF63?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>When to Use AI: Head vs Heart Work
Core Concept Overview
Shawaiz introduces the "head vs heart" work framework to guide effective AI usage.
Head work follows patterns and rules; heart work requires judgment, creativity, and personal growth.
Head Work vs Heart Work
Use AI for head work: calculations, grammar, research, organization, formatting, and fact-checking—these are mechanical and pattern-based.
Heart work includes forming arguments, creative thinking, personal learning, and decisions—areas where AI consistently falls short.
Actionable Recommendations
Delegate routine, patterned tasks to AI – maximize efficiency for mechanical work.
Own your creative and learning activities – protect these from AI to support growth.
Distinguish the two types of work – assess each task and decide accordingly.
Use head/heart awareness to develop key skills – critical for thriving in the AI era.
Practice identifying the difference – skillful separation ensures best personal development and performance.


This video explains the 'head versus heart' framework to distinguish between tasks suited for AI and those requiring human creativity and judgment. Head work involves mechanical, pattern-based tasks where AI excels, such as grammar checking and calculations. Heart work involves unique, personal, and creative tasks that AI cannot perform well, such as original problem solving and moral decisions.</p>`,
  ...
  "4-3": {
    ...
    summary: `<p>Identifying Real Goals in the AI Era
Overview
Shawaiz explains that understanding the "real goal" behind any task is a critical life and AI-era skill.
Most people focus on surface objectives or the tools rather than the true outcomes they need.
Main Insights
The tool you choose should be dictated by your real goal, not routine or habit (illustrated by a personal example with tools).
Common mistake: confusing the means (how) with the purpose (what). For example, doing assignments mechanically versus focusing on learning skills.
In rapidly changing times, especially with AI, those who identify with "how" risk becoming obsolete; those who identify with "what" stay relevant.
Recommendations
Regularly ask: Who benefits if I do this well? What is the true outcome I need?
Distinguish between the surface and real goal before starting any task.
Focus on core value and personal growth, not just efficiency or quick completion.
Allow "how" to change with tools and technology—never lose sight of "what" you are achieving.
Remember: Success comes from clarity of purpose, not attachment to process or method.
...
This video emphasizes the critical skill of identifying the real goal behind tasks rather than just focusing on surface-level objectives. It illustrates how understanding the true purpose helps in choosing the right tools and approaches, especially in the AI era where the process ('how') may change but the fundamental objectives ('what') remain constant. The speaker uses practical examples to highlight the importance of focusing on learning and growth rather than just completing tasks mechanically with AI assistance</p>`,
  ...
  "4-4": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/jIsyz7O688CPRs8pLa9a?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/KS13Bap3QGe6hvsTzjTN?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Strategic AI Use for Smarter Task Management
Overview
Shawaiz explains how breaking tasks into components enables efficient collaboration between personal effort and AI, using essay writing as a practical example.
Main Insights
Some parts of a task add personal value—like developing arguments and making judgments—that should be done by you.
AI is most useful for mechanical work: gathering quotes, checking grammar, formatting, and suggesting improvements.
Certain steps, such as outlining or polishing drafts, can be handled by either you or AI, depending on your learning goals and time constraints.
Actionable Takeaways
Break every task into clear components before deciding where to apply AI.
Use AI strategically for repetitive or technical steps, not for creative or critical thinking parts.
Aim for a balanced approach—neither full automation nor complete manual effort—to maximize learning, quality, and time savings.</p>`,
  ...
  "4-5": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/GSdH7cDakAvi7T2cLTWE?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/aLyWY4mabqRFvTCOetLA?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Five Common AI Traps and Success Strategies
Overview
Shawaiz exposes five key traps people fall into when using AI and shares ways to avoid them.
The focus is on practical skills and developing a strong, winning mentality with AI.
Main Insights
The five traps are: hallucination (trusting made-up info), trigger-happy reliance, automating tasks you enjoy, invisible skill decay, and giving AI poor context.
Winners use AI to multiply effort, not replace it; losers rely on shortcuts and risk losing capability.
Use AI as a tool that pushes you further, not as a crutch that makes you dependent.
Actionable Takeaways
Validate outputs – Always fact-check AI information to avoid hallucinations.
Think before automating – Use discipline, don’t reflexively hand tasks to AI.
Protect your passions – Avoid automating activities that energize or define you.
Train your skills – Use AI to boost, not replace, your core strengths.
Provide clear context – Give AI enough information for valuable, customized results.


This video discusses five common traps when using AI: hallucination (AI generating false information), trigger happy (over-reliance on AI leading to loss of independent thinking), automation of joy (losing passion by automating enjoyable tasks), invisible decay (skills deteriorating due to dependence on AI), and context-free use (getting generic outputs without proper input). It emphasizes the importance of using AI as a tool to enhance capabilities rather than replace skills, and maintaining discipline and awareness to avoid these pitfalls</p>`,
  ...
  "4-6": {
    ...
    summary: `<p>Mastering AI: Tactics for Mindful Use
Overview
Shawaiz explains that while AI can be a powerful tool, mindful and intentional use is essential to maintaining human value and skills in a rapidly evolving landscape.
Core Strategies and Insights
Five prevention tactics: deliberate delay, AI-free periods, weekly self-testing, cross-checking AI outputs, and creating personal rules for AI use.
Overreliance on AI can lead to skill decline; adaptability and good judgment become critical as “head work” becomes widely automated.
Emotional intelligence, kindness, and human judgment cannot be replicated by AI, increasing their value.
Actionable Takeaways
Pause and reflect before using AI—make usage a conscious choice.
Schedule regular periods or tasks where no AI assistance is used.
Routinely challenge and verify AI responses to avoid blind trust.
Establish personal rules to guide when and how you use AI.
Focus on developing uniquely human qualities and adaptability—these will drive future value.

The video discusses five key tactics to prevent misuse of AI, emphasizing deliberate and reflective use rather than reflexive reliance. It highlights the importance of maintaining human skills through AI-free periods and self-testing, challenging AI outputs critically, and setting personal rules for AI use. The video also explores the future impact of AI on work, stressing that human qualities like emotion, judgment, and kindness will become increasingly valuable as AI automates routine tasks.</p>`,
    activity: `<p>Replace with actual activity content</p>`
  },

  "5-1": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/LlLoVMu8IMG0Y8EzCRol?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/LlLoVMu8IMG0Y8EzCRol?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Mastering AI: How Prompt Quality Drives Results
Why Most People Get Different AI Results
Shawaiz explains that everyone has access to the same AI; results differ due to how people interact with it.
The real difference is the quality and clarity of communication, not the AI’s power itself.
How to Get Better Results from AI
AI is compared to a massive warehouse: your request (prompt) determines what you receive.
Vague prompts yield vague results; specific prompts (specifying length, topic, audience, tone, etc.) enable superior outputs.
Shawaiz emphasizes: "Garbage in, garbage out; gold in, gold out"—input quality determines output quality.
Key Recommendations for Effective AI Communication
Focus on creating clear, precise prompts for best results.
Always include context: specify your goals, constraints, and desired outcome.
Remember: the way you communicate with AI saves time, boosts productivity, and distinguishes you from others.

This video explains the importance of effective communication with AI to achieve better results. It emphasizes that everyone has access to the same AI tools, but the quality of the output depends on the quality of the input prompts. Good prompts are specific, detailed, and context-aware, which leads to more productive and efficient AI interactions.</p>`,
  ...
  "5-2": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/7YymJNqbWzdbai38jBPD?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/GIZa0EEYQxG8K7atsQ0f?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Mastering AI Prompts with the COLD STAR Framework
Overview
Shawaiz introduces the COLD STAR framework to help users structure AI prompts for superior results, emphasizing that clarity and specificity drive quality AI outputs.
Key Framework Insights
COLD STAR stands for Context, Objective, Style, Tone, Audience, Response.
Providing thorough background, clear goals, desired writing style, precise tone, specific audience, and response format ensures tailored and effective AI answers.
Vague prompts lead to generic results; the more specific your prompt, the better the AI performance and less post-editing is needed.
Actionable Takeaways
Break down every prompt using all six COLD STAR elements.
Always specify context and objectives for relevance.
Match style and tone to fit your audience.
Define your target audience and response format.
Review prompts for completeness to optimize productivity.
Guide Steps
Identify and specify the context for your prompt, including situation, goal, constraints, and background.
Define the objective of your prompt by stating what you want to achieve and who it is for.
Specify the response style (e.g., conversational, direct, professional, or casual).
Choose a tone (e.g., formal, casual, urgent, playful, empowering).
Determine your audience by considering their age, expertise, and interests.
Specify the preferred response format (essay, bullet points, outline, guide, or conversation).
Review your prompt to ensure it covers all COLD STAR elements.

This video introduces the Cold Star framework, a structured approach to crafting effective AI prompts by providing context, objective, style, tone, audience, and response format. It emphasizes the importance of specificity in prompts to achieve tailored and high-quality AI outputs, enhancing productivity and reducing wasted time. The video also highlights how giving AI detailed context transforms it from a stranger to a helpful assistant, ensuring better alignment with user goals.</p>`,
  ...
  "5-3": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/smM2B5ghmo6PQ37MjVlh?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/zrYcpz0yf5r562MdRGb8?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Mastering Effective AI Prompting Techniques
Overview of Iterative Prompting
Shawaiz stresses treating AI prompting as a process, not a one-shot task.
Users should refine prompts based on specific feedback, targeting issues rather than rewriting from scratch.
Key Strategies and Examples
Analyze outputs, identify particular shortcomings, then adjust prompts gradually for better results.
Meta-prompting: Ask AI directly how to improve a prompt for more precise suggestions.
Output control: Specify format, length, tone, style, key elements, and constraints to guide AI responses accurately.
Actionable Takeaways
Break down prompt refinement into focused, targeted adjustments.
Use meta-prompting to have AI critique and enhance your instructions.
Clearly state output requirements to minimize needed iterations.
Apply process thinking for efficiency and higher-quality results.
Avoid complete rewrites — fix only what’s necessary for improvement.


The video explains the iterative process of refining AI prompts to achieve better outputs. It emphasizes analyzing the output, making targeted adjustments, and using meta-prompting to ask AI for improvement suggestions. Additionally, it highlights controlling output aspects like format, length, tone, and style to get the desired result efficiently.</p>`,
  ...
  "5-4": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/smM2B5ghmo6PQ37MjVlh?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/zrYcpz0yf5r562MdRGb8?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Mastering Meta Prompting for AI Efficiency
Overview
Shawaiz explains how meta prompting lets AI generate prompts for you, enhancing quality and automation in prompt engineering.
Manual prompting is still necessary as a foundation for understanding and evaluating AI-generated prompts.
How Meta Prompting Works
Meta prompting is compared to having two workers: one gathers context and expertise, the other generates the actionable prompt.
AI creates structured prompts from your inputs, which are then reused for superior outputs.
Learning manual prompting helps detect deficiencies and ensures the right audience, goals, and roles are captured in prompts.
Actionable Takeaways
Learn manual prompting first to build deep understanding and control.
Use meta prompting to accelerate and scale prompt creation once experienced.
Combine both techniques for optimal results in AI-driven workflows.

This video explains the concept of meta prompting, where AI is used to write prompts for AI, enhancing prompt quality and efficiency. It emphasizes the importance of first mastering manual prompting to understand and evaluate AI-generated prompts effectively. The video also illustrates the process of meta prompting using an analogy of two workers communicating tasks to achieve high-quality outputs.</p>`,
  ...
  "5-5": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/Np5K3UE8I83IoEZpD5DK?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
...
This video explains the concept of meta prompting, where AI is used to write prompts for AI, enhancing prompt quality and efficiency. It emphasizes the importance of first mastering manual prompting to understand and evaluate AI-generated prompts effectively. The video also illustrates the process of meta prompting using an analogy of two workers communicating tasks to achieve high-quality outputs.</p>`,
  ...
  "5-6": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/PnDpJbUTaQFidGMYYJwX?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/Ru8lwYgsmvMGZunwV8AC?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Mastering Effective AI Communication and Prompting
Core Context
Shawaiz explains common mistakes in prompt engineering and emphasizes refining questions rather than switching topics.
Using iteration and patience is key to better AI results, rather than expecting immediate, perfect answers.
Main Insights on Prompting
Do not assume AI can "read your mind"; always provide clear, explicit inputs.
Clearly state your constraints (deadlines, requirements) upfront to avoid frustration with outputs.
Use AI for repetitive or tedious work so you can focus on creative, "genius" tasks unique to you.
Actionable Takeaways
Iterate your prompts – Refine instead of restarting each time.
Communicate with clarity – Specify needs and constraints directly.
Leverage AI wisely – Let AI handle routine work, preserving your unique strengths.
Embrace mistakes as learning – Allow errors to naturally improve your prompting skills.
Develop communication overall – Practicing prompt engineering also sharpens real-world communication skills.

This video provides a comprehensive guide on effective prompt engineering for AI, emphasizing the importance of refining questions iteratively, setting clear constraints, and using AI to handle hard work so humans can focus on their unique strengths. It highlights common mistakes such as assuming AI understands unstated needs and the necessity of clear communication, which also improves overall communication skills. The video also outlines a structured learning path through multiple modules covering AI fundamentals, practical usage, and advanced prompting techniques.</p>`,
  ...
  "6-1": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/uOE6a3m25cFAT0hmnF0B?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/1LWWh3M9HkMH3jyKaG0J?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>How to Become a Resilient AI User
Overview: Shawaiz’s Core Message
Shawaiz explains the difference between “how” and “what” thinking in the AI age.
The focus is on thriving amid rapid changes in AI tools.
The Three Levels of AI Users
Level 1: “How-obsessed” dabblers frequently chase new tools, but make little long-term progress.
Level 2: Skilled at current tools and prompts, reactive not proactive, struggle as tools change.
Level 3: Elite “what-focused” users build adaptable systems, prioritizing outcomes and resilient workflows over specific tools.
Actionable Takeaways
Shift focus from mastering specific tools to building outcome-driven systems.
Regularly evaluate and update your processes, not just your toolset.
Build workflows around core needs (e.g., research, organization, refinement) so they survive tool changes.
Aim to be a “what person”—future-proof your AI skills by thinking strategically.
Remember: Lasting value comes from systems, not from chasing every new “how.”

This video lesson discusses the three levels of AI users: dabblers, skilled users, and elite users. It emphasizes the importance of focusing on the 'what' (outcomes and systems) rather than the 'how' (specific tools), as AI tools rapidly change. The goal is to become a level three AI user who builds resilient systems that adapt to evolving AI technologies.</p>`,
  ...
  "6-2": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/3VCsV8qBtju09dWIDRSO?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/6IVzDq4i6UqNqHNAoc5N?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Strategic Filtering for Outcome-Focused AI
Overview
Shawaiz explains how high-level AI users (“Tier 3”) achieve better results by shifting focus from tool features to desired outcomes.
Rather than chasing trends, effective users ask if an AI tool delivers the specific results they need.
Core Insights
Prioritize evidence and fit—use AI tools based on real outcomes, not hype or novelty.
Say “no” to most tools, going deep only on what aligns tightly with daily and important tasks.
Integrate new tools into existing systems for sustained, repeatable gains.
Actionable Takeaways
Filter for outcomes, not features—clarify goals before assessing tools.
Rely on evidence, avoid hype—let proven results guide decisions.
Ensure tool compatibility—only add AI that fits current workflows.

The video discusses the concept of strategic filtering in AI usage, emphasizing the importance of focusing on outcomes rather than the tools themselves. It highlights how tier 3 AI users base their AI adoption on evidence and fit within their existing systems, using AI selectively and with discipline to achieve reliable and repeatable gains. The analogy of choosing clothes from a wardrobe is used to illustrate the approach of deciding on outcomes first before selecting the appropriate AI tools.</p>`,
  ...
  "6-3": {
    ...
    summary: `<p>Staying Informed on AI Without Overwhelm
Context: Why Limit AI News?
Shawaiz explains that constant updates in AI—new tools, features, and industry drama—can consume hours daily and lead to information overload.
Most people either spend too much time on news or risk falling behind altogether.
The News Budget Strategy
Set a strict limit: 15–30 minutes per week to check AI news—no daily monitoring.
Choose one or two curated sources focused on meaningful outcomes, not just the latest tools.
Each week, scan for 1-3 key developments and ignore the rest.
Actionable Takeaways
Set limits – Allocate a maximum of 30 minutes weekly for AI news.
Curate sources – Pick 1-2 trusted, high-value news channels.
Focus decisions – Try only 1-3 new ideas or actions each week.
Prioritize lightly – Stay informed but avoid obsessive tracking.
Balance – Remain up-to-date without feeling overwhelmed.

This video lesson discusses how to manage AI news consumption effectively by setting a limited 'news budget' of 15 to 30 minutes once per week. It emphasizes selecting one to two curated sources that focus on relevant AI developments and making informed decisions based on a few key updates to stay current without becoming overwhelmed.</p>`,
  ...
  "6-4": {
    ...
    summary: `<p>How to Effectively Test New Tools
Overview
Shawaiz explains a structured approach for evaluating new tools with a focused 30-60 minute trial.
The method ensures tools are tested against your real needs, not just their intended functions.
Key Evaluation Process
Define a specific goal for the trial, aiming for clear outcomes and time savings (30-50%) without sacrificing quality.
Test the tool using 1-3 real examples from your own workflow, not hypotheticals or marketing claims.
Make an informed decision: adopt if effective, park for later review, or reject if it fails core criteria.
Actionable Takeaways
Only test tools that show strong design, documentation, and positive user results.
Skip trials if outputs need heavy fixing or documentation is weak.
Integrate and master tools that consistently deliver value—otherwise, revisit or reject them.

This video lesson explains the process of conducting a 30 to 60 minute trial to evaluate new tools or solutions after they pass an initial filter. It emphasizes setting clear goals, testing with real work examples, and making informed decisions to adopt, park, or reject the tool based on consistent performance and evidence of time savings and quality.</p>`,
  ...
  "6-5": {
    ...
    summary: `<p>Building Flowing Systems with Integrated AI
Overview
Shawaiz describes how systems that flow differ from disconnected tool use, emphasizing the importance of designing around your core goal.
Fragmented tools lead to lost context and inefficiency; integrated systems support continuous, focused work.
Main Insights
True productivity comes from systems where AI is seamlessly woven in—such as Google Docs with built-in AI—rather than juggling separate tools.
Most struggle with AI because they focus on "how" to use tools, and not "what" they want to achieve.
Mature integrated systems grow stronger over time, yielding compounding returns without restarting from scratch.
Recommendations
Focus on building systems, not collecting tools.
Integrate AI into existing workflows rather than using it as an add-on.
Define desired outcomes and processes before selecting tools.
Prioritize stable, flowing systems for long-term improvements.
Ignore marketing hype; optimize for real productivity gains.

The video explains the concept of system flow versus fragmented tools, emphasizing the importance of integrating AI seamlessly into workflows to enhance productivity. It contrasts tier 1 and tier 2 users who use disconnected tools with tier 3 users who have mature systems that flow smoothly and improve over time. The key takeaway is to focus on outcomes and building systems that compound returns rather than merely adding AI tools.</p>`,
  ...
  "6-6": {
    ...
    summary: `<p>How to Evaluate AI Outputs Based on Task Importance
Context and Approach
Shawaiz explains that mature AI users apply clear evaluation criteria rather than trusting or rejecting AI blindly.
Task importance determines standards: low-stakes tasks prioritize speed, while high-stakes tasks require thorough verification.
Main Evaluation Criteria
Five key checks for AI outputs: relevance, factual accuracy, completeness, clarity, and absence of bias.
For low-stakes tasks (e.g., drafts, summaries), fast iteration is fine; for medium-stakes, use human review; for high-stakes, human leads and AI only assists.
Actionable Takeaways
Assess AI outputs using relevance, accuracy, completeness, clarity, and bias checks.
Vary your trust in AI depending on the risk of the task.
Always refine and verify AI outputs for high-stakes work.
Involve human review as task importance increases.
Adapt AI usage standards rather than applying a one-size-fits-all approach.

The video discusses the evaluation criteria for AI outputs, emphasizing the importance of high standards for different stakes of tasks. It outlines five key criteria: relevance, factual accuracy, completeness, clarity, and bias check, and explains how users should adapt their trust and verification processes based on the risk level of the task, ranging from low to high stakes.</p>`,
  ...
  "6-7": {
    ...
    summary: `<p>Building Effective AI Playbooks for Lasting Results
Overview
Shawaiz explains how advanced AI playbooks give users a powerful, long-term edge over those who rely on scattered tools or chase quick wins.
Tier 3 users focus on documented, repeatable processes that combine human strategy with AI capabilities for compounding results.
Key Concepts and Methodology
A playbook is a step-by-step, documented process marking where AI and human roles intersect, adaptable as tools or goals change.
Ideal playbook uses include research, writing, studying, project planning, content creation, and any routine involving clear steps.
The five core steps for high-quality outputs: identify research angles, extract relevant arguments, structure logic, express clearly, and ensure flow/strength—these remain, even as AI handles execution.
Actionable Takeaways
Focus on systems, not just tools, to build a lasting advantage.
Document and regularly update your processes to improve efficiency and save time.
Use AI strategically: test new tech briefly, then go deep on the best fits.
Stay adaptable—let AI handle more, but always maintain clarity on what you do versus what AI does.
Start building your first "what" system documented as a playbook for greatest impact.

This video lesson focuses on the concept of AI playbooks as a strategic tool for tier 3 users to build efficient, repeatable processes that integrate AI for tasks such as research, writing, and project planning. It emphasizes the importance of mastering systems over tools, strategic filtering, and long-term thinking to gain a compound advantage in AI usage. The lesson also outlines a detailed example of creating a playbook for producing a well-researched essay, highlighting the consistent process steps and the evolving role of AI in executing them</p>`,
    activity: `<p>Activity content coming soon</p>`
  },

  "7-1": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/xVF6mdhPiHGNei0TGKau?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    guide: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: 66.67%;"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/guides/NAuQ4RFSYDNeEow6qZLQ?view=interactive" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
    summary: `<p>Adapting for the AI-Driven Future
Overview
Shawaiz explains how the value of skills is rapidly shifting due to widespread adoption of AI.
The lesson focuses on how to position oneself to succeed as technology reshapes job roles.
Key Insights
Pattern-based tasks (routine analysis, information retrieval) are less valuable, as AI now handles these better and faster.
Human-only skills—creativity, judgment, ethical reasoning, and relationship-building—are becoming scarcer and more prized.
The shelf life of technical skills is shrinking; roles now change 25% faster than five years ago.
Actionable Takeaways
Continuously develop uniquely human skills to remain valuable.
Use AI strategically to maximize your advantage, not as a crutch.
Foster a mindset of lifelong learning and adaptability for career resilience.
Recognize that skills must be updated regularly, not just learned once.
Anticipate accelerated change as AI capabilities double every five years.

This video discusses the shifting value of skills in the age of AI, emphasizing that pattern recognition and routine tasks are becoming less valuable as AI performs them better and faster. Conversely, uniquely human skills such as creativity, judgment, and ethical reasoning are becoming scarcer and more valuable. Continuous learning and strategic use of AI are essential to stay relevant as roles and required skills evolve rapidly.</p>`,
  ...
  "7-2": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/4Cj2tfRW9wZW3r89fLIB?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
  ...
  "7-3": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/5tg88YzCvPtjWe18dNYk?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
  ...
  "7-4": {
    video: `<div style="position: relative; width: 100%; height: 0px; overflow: hidden; padding-bottom: min(62.5%, 95vh);"><iframe allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" playsinline="" allow="autoplay; fullscreen; picture-in-picture" src="https://kommodo.ai/embed/recordings/wALkx0MYC0vFsv69rZhw?onlyRecording=1" width="100%" height="100%" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>`,
