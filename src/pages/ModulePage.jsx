  ...
  return (
    <div className="flex-1 overflow-y-auto relative">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 relative z-10">
          ...
          {/* Progress */}
          <div className={`mb-12 sm:mb-24 border-2 border-slate-200 rounded-lg p-4 sm:p-6 lg:p-8 shadow-lg bg-white/80 backdrop-blur-sm transition-all duration-300 ${hoverProgressClasses}`}>
          ...
          {moduleIntros[moduleIdNum] && (
            <div className={`mb-12 sm:mb-24 border-2 border-cyan-600 rounded-lg overflow-hidden shadow-lg bg-white/80 backdrop-blur-sm transition-all duration-300 ${hoverOverviewClasses}`}>
              ...
              {module.lessons.map((lesson) => {
                ...
                return (
                  <Link
                    ...
                    className={`block p-3 sm:p-6 border-2 border-slate-200 rounded-lg bg-white/80 backdrop-blur-sm ${hoverLessonClasses} transition-all duration-300`}
                  >
