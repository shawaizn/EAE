 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ei=W("Check",[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const di=W("Target",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["circle",{cx:"12",cy:"12",r:"6",key:"1vlfrh"}],["circle",{cx:"12",cy:"12",r:"2",key:"1c9p78"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
</div>`,activity:"<p>Activity content coming soon</p>"},getLesson(e,t){const n=`${e}-${t}`;return this[n]}},L={bg:l.colors.background.light||l.colors.background.base,cardBg:l.colors.background.card,textPrimary:l.colors.text.primary,textSecondary:l.colors.text.secondary,textMuted:l.colors.text.muted,accent:l.colors.accent.cyan,accentLight:`${l.colors.accent.cyan}15`,primary:l.colors.primary.deep,border:l.colors.border.subtle,success:l.colors.status.success};function Qy(){const{user:e,signOut:t}=Je();Nt();const{moduleId:n,lessonId:o}=ci(),[s,r]=b.useState(!0),[a,c]=b.useState(!1),[u,d]=b.useState(!1),[m,h]=b.useState(!1),[g,p]=b.useState(!1),[v,x]=b.useState(null),{isComplete:A,toggleComplete:y,loading:f}=mi(e==null?void 0:e.id,[]),{isBookmarked:w,toggleBookmark:k}=$m(e==null?void 0:e.id),S=parseInt(n),T=parseInt(o),N=Se.find(pe=>pe.id===S),R=N==null?void 0:N.lessons.find(pe=>pe.id===T);if(!N||!R)return i.jsx("div",{className:"flex-1 p-8",children:i.jsx("p",{children:"Lesson not found"})});if(f)return i.jsx("div",{className:"flex-1 flex items-center justify-center",children:i.jsx("div",{className:"text-gray-600",children:"Loading..."})});const C=Yy.getLesson(S,T),I=`${S}-${T}`,M=ni[I],_=dn(S,T),H=A(_,"lesson");if(!C)return i.jsx("div",{className:"flex-1 p-8",children:i.jsx("p",{children:"Lesson content not available"})});const ke=pe=>{const z=document.createElement("div");z.innerHTML=pe;let E="";const B=(U,ae="")=>{if(U.nodeType===Node.TEXT_NODE){const Ae=U.textContent.trim();Ae&&(E+=Ae+" ")}else if(U.nodeType===Node.ELEMENT_NODE){const Ae=U.tagName.toLowerCase();Ae==="h3"||Ae==="h2"?(E.trim()&&(E=E.trim()+`
