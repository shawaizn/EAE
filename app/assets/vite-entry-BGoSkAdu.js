 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Dc=W("Briefcase",[["rect",{width:"20",height:"14",x:"2",y:"7",rx:"2",ry:"2",key:"eto64e"}],["path",{d:"M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16",key:"zwj3tp"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bc=W("Megaphone",[["path",{d:"m3 11 18-5v12L3 14v-3z",key:"n962bs"}],["path",{d:"M11.6 16.8a3 3 0 1 1-5.8-1.6",key:"1yl0tm"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
</div>`,activity:"<p>Activity content coming soon</p>"},getLesson(e,t){const n=`${e}-${t}`;return this[n]}},L={bg:l.colors.background.light||l.colors.background.base,cardBg:l.colors.background.card,textPrimary:l.colors.text.primary,textSecondary:l.colors.text.secondary,textMuted:l.colors.text.muted,accent:l.colors.accent.cyan,accentLight:`${l.colors.accent.cyan}15`,primary:l.colors.primary.deep,border:l.colors.border.subtle,success:l.colors.status.success};function Hy(){const{user:e,signOut:t}=Je();Nt();const{moduleId:n,lessonId:o}=li(),[s,r]=b.useState(!0),[a,c]=b.useState(!1),[u,d]=b.useState(!1),[m,h]=b.useState(!1),[g,p]=b.useState(!1),[v,x]=b.useState(null),{isComplete:A,toggleComplete:y,loading:f}=di(e==null?void 0:e.id,[]),{isBookmarked:w,toggleBookmark:k}=$m(e==null?void 0:e.id),S=parseInt(n),T=parseInt(o),N=Se.find(pe=>pe.id===S),R=N==null?void 0:N.lessons.find(pe=>pe.id===T);if(!N||!R)return i.jsx("div",{className:"flex-1 p-8",children:i.jsx("p",{children:"Lesson not found"})});if(f)return i.jsx("div",{className:"flex-1 flex items-center justify-center",children:i.jsx("div",{className:"text-gray-600",children:"Loading..."})});const C=Gy.getLesson(S,T),I=`${S}-${T}`,M=ti[I],_=un(S,T),Y=A(_,"lesson");if(!C)return i.jsx("div",{className:"flex-1 p-8",children:i.jsx("p",{children:"Lesson content not available"})});const ke=pe=>{const z=document.createElement("div");z.innerHTML=pe;let E="";const D=(U,ae="")=>{if(U.nodeType===Node.TEXT_NODE){const Ae=U.textContent.trim();Ae&&(E+=Ae+" ")}else if(U.nodeType===Node.ELEMENT_NODE){const Ae=U.tagName.toLowerCase();Ae==="h3"||Ae==="h2"?(E.trim()&&(E=E.trim()+`
